            ...
            <div className="other">
                <article className="a-content">
                    ...
                    <section className="a-text3">
                        <h2>Our History</h2>
                        <p>[Briefly describes the college's history - e.g., how it started, key milestones, growth over the years, famous alumni if any]. Our journey began with a vision to make quality education available to all, and we continue that legacy today.</p>
                    </section>
                </article>
            </div>
            <div><Footer /></div>
